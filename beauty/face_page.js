...
function face_wash_filter(){
    fetch(`https://nitrogen-project.herokuapp.com/face_page?category=face_wash`)
    .then(res => res.json())
    .then(res => {
        displayData(res)
        console.log(res)
...
function face_mask_filter(){
    fetch(`https://nitrogen-project.herokuapp.com/face_page?category=face_mask`)
    .then(res => res.json())
    .then(res => {
        displayData(res)
        console.log(res)
...
function face_scrub_filter(){
    fetch(`https://nitrogen-project.herokuapp.com/face_page?category=face_scrub`)
    .then(res => res.json())
    .then(res => {
        displayData(res)
        console.log(res)
...
function face_cream_filter(){
    fetch(`https://nitrogen-project.herokuapp.com/face_page?category=face_cream`)
    .then(res => res.json())
    .then(res => {
        displayData(res)
        console.log(res)
...
function showData(){
    let url = "https://nitrogen-project.herokuapp.com/face_page"
    fetch(url)
    .then(res => res.json())
    .then(res => displayData(res))
}
